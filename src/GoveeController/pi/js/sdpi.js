...
class StreamDeckClient {
    ...
    get(event, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield stream_deck_connection_1.default.get(Message.SEND_TO_PLUGIN, args => args.event == Message.SEND_TO_PROPERTY_INSPECTOR && args.payload && args.payload.requestId == request.requestId, Object.assign({ data: Object.assign({}, parameters) }, request));
        });
    }
    ;
    getGlobalSettings() {
